...
class WooCommerce_Role_Based_Price_AeliaCurrencySwitcher_Plug {
    ...
    public function admin_init(){
        add_filter('wc_rbpsection_aelia-currencyswitcher-integration',array($this,'add_settings'));
        ...
        add_filter('wc_rbp_sections',array($this,'add_section'));
				...
				// Override the product prices on the frontend
				if(!is_admin() || WooCommerce_Role_Based_Price::doing_ajax()) {
    ...
    public function add_section($section){
        $section['aelia-currencyswitcher-integration'] = __('Aelia Currency Switcher',lang_dom);
        return $section;
